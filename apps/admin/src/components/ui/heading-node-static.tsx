...
const headingVariants = cva("relative mb-1", {
  variants: {
    variant: {
      h1: "font-heading mt-[1.6em] pb-1 text-4xl font-bold first:mt-0",
      h2: "font-heading mt-[1.4em] pb-px text-2xl font-semibold tracking-tight first:mt-0",
      h3: "font-heading mt-[1em] pb-px text-xl font-semibold tracking-tight first:mt-0",
      h4: "font-heading mt-[0.75em] text-lg font-semibold tracking-tight first:mt-0",
      h5: "mt-[0.75em] text-lg font-semibold tracking-tight first:mt-0",
      h6: "mt-[0.75em] text-base font-semibold tracking-tight first:mt-0",
    },
  },
});
