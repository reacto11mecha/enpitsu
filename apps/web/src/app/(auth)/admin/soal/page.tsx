  ...
  return (
    <div className="mt-5 flex flex-col gap-7 px-5">
      ...
      <div className="flex flex-col gap-3 pb-10">
        {countValue < 1 ? <div className="space-y-1">
          <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">
            Daftar Soal
          </h4>
          <p className="text-muted-foreground">Tidak bisa membuat soal baru, belum ada <Link className="underline" href="/admin/angkatan">data angkatan atau rombongan belajarnya</Link>.</p>
        </div> :
          <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">
            Daftar Soal
          </h4>
